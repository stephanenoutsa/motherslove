...
public class IntroductionMalnutrition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_introduction_malnutrition);
        ...
        TextView malnutrititonIntro = (TextView) findViewById(R.id.malnutrititonIntro);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        malnutrititonIntro.setTypeface(typeface);
    }
