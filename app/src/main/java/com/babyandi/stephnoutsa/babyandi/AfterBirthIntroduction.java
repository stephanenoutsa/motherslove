...
public class AfterBirthIntroduction extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_after_birth_introduction);
        ...
        TextView afterBirthIntro = (TextView) findViewById(R.id.afterBirthIntro);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        afterBirthIntro.setTypeface(typeface);
    }
