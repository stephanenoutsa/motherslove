...
public class Zscores extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zscores);
        ...
        TextView muacText2 = (TextView) findViewById(R.id.muacText2);
        TextView zScoreText2 = (TextView) findViewById(R.id.zScoreText2);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        muacText2.setTypeface(typeface);
        zScoreText2.setTypeface(typeface);
    }
