...
public class ANCIntro extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ancintro);
        ...
        TextView ancIntroText = (TextView) findViewById(R.id.ancIntroText);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        ancIntroText.setTypeface(typeface);
    }
