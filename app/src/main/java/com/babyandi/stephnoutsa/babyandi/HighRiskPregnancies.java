...
public class HighRiskPregnancies extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_high_risk_pregnancies);
        ...
        TextView highRiskPregnancies = (TextView) findViewById(R.id.highRiskPregnancies);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        highRiskPregnancies.setTypeface(typeface);
    }
