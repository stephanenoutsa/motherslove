...
public class AcuteDiarrhoea extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_acute_diarrhoea);
    ...
    public void onClickDefinitionAcuteDiarrhoea(View view) {
        Intent i = new Intent(this, DefinitionAcuteDiarrhoea.class);
        startActivity(i);
    }

    public void onClickPresentationAcuteDiarrhoea(View view) {
        Intent i = new Intent(this, PresentationAcuteDiarrhoea.class);
        startActivity(i);
    }

    public void onClickManagementAcuteDiarrhoea(View view) {
        Intent i = new Intent(this, ManagementAcuteDiarrhoea.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
