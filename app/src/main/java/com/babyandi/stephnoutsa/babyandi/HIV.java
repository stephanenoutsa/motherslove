...
public class HIV extends AppCompatActivity {
    ...
    public void onClickHIVIntroduction(View view) {
        Intent i = new Intent(this, HIVIntroduction.class);
        startActivity(i);
    }

    public void onClickHIVApproach(View view) {
        Intent i = new Intent(this, HIVApproach.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
