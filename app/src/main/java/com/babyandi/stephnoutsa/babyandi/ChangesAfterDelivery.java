...
public class ChangesAfterDelivery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_changes_after_delivery);
        ...
        TextView changesAfterDelivery = (TextView) findViewById(R.id.changesAfterDelivery);
        TextView changesAfterDelivery2 = (TextView) findViewById(R.id.changesAfterDelivery2);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        changesAfterDelivery.setTypeface(typeface);
        changesAfterDelivery2.setTypeface(typeface);
    }
