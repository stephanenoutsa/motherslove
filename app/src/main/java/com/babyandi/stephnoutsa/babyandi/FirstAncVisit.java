...
public class FirstAncVisit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_first_anc_visit);
        ...
        TextView firstAncVisitText = (TextView) findViewById(R.id.firstAncVisitText);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        firstAncVisitText.setTypeface(typeface);
    }
