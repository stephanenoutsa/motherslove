...
public class BeforeBirth extends AppCompatActivity {
    ...
    public void onClickBeforeBirthANC(View view) {
        Intent i = new Intent(this, BeforeBirthANC.class);
        startActivity(i);
    }

    public void onClickHEDuringPregnancy(View view) {
        Intent i = new Intent(this, HEDuringPregnancy.class);
        startActivity(i);
    }
    public void onClickCommonComplaintsDuringPregnancy(View view) {
        Intent i = new Intent(this, CommonComplaintsDuringPregnancy.class);
        startActivity(i);
    }

    public void onClickHighRiskPregnancies(View view) {
        Intent i = new Intent(this, HighRiskPregnancies.class);
        startActivity(i);
    }

    public void onClickDangerSignsDuringPregnancy(View view) {
        Intent i = new Intent(this, DangerSignsDuringPregnancy.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
