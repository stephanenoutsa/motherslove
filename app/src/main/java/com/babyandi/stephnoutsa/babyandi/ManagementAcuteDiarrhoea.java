...
public class ManagementAcuteDiarrhoea extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_management_acute_diarrhoea);
    ...
    public void onClickNoDehydration(View view) {
        Intent i = new Intent(this, NoDehydration.class);
        startActivity(i);
    }

    public void onClickLittleDehydration(View view) {
        Intent i = new Intent(this, LittleDehydration.class);
        startActivity(i);
    }

    public void onClickSevereDehydration(View view) {
        Intent i = new Intent(this, SevereDehydration.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
