...
public class PreparingForLabour extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_preparing_for_labour);
        ...
        TextView preparingForLabour = (TextView) findViewById(R.id.preparingForLabour);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        preparingForLabour.setTypeface(typeface);
    }
