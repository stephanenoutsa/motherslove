...
public class AfterBirth extends AppCompatActivity {
    ...
    public void onClickAfterBirthIntroduction(View view) {
        Intent i = new Intent(this, AfterBirthIntroduction.class);
        startActivity(i);
    }

    public void onClickChangesAfterDelivery(View view) {
        Intent i = new Intent(this, ChangesAfterDelivery.class);
        startActivity(i);
    }
    public void onClickFrequentComplaintsAfterDelivery(View view) {
        Intent i = new Intent(this, FrequentComplaintsAfterDelivery.class);
        startActivity(i);
    }

    public void onClickHEAfterDelivery(View view) {
