...
public class SeverePersistentDiarrhoeaDefinition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_severe_persistent_diarrhoea_definition);
        ...
        severePersistentDiarrhoeaDefinition.setTypeface(typeface);
    }
