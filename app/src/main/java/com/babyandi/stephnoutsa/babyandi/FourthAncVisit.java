...
public class FourthAncVisit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fourth_anc_visit);
        ...
        TextView fourthAncVisitText = (TextView) findViewById(R.id.fourthAncVisitText);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        fourthAncVisitText.setTypeface(typeface);
    }
