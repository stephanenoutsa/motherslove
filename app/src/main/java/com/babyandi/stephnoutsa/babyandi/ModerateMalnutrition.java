...
public class ModerateMalnutrition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moderate_malnutrition);
        ...
        TextView moderateMalnutrition = (TextView) findViewById(R.id.moderateMalnutrition);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        moderateMalnutrition.setTypeface(typeface);
    }
