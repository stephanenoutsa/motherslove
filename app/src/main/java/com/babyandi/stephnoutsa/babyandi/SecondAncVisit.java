...
public class SecondAncVisit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_second_anc_visit);
        ...
        TextView secondAncVisitText = (TextView) findViewById(R.id.secondAncVisitText);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        secondAncVisitText.setTypeface(typeface);
    }
