...
public class Diarrhoea extends AppCompatActivity {
    ...
    public void onClickAcuteDiarrhoea(View view) {
        Intent i = new Intent(this, AcuteDiarrhoea.class);
        startActivity(i);
    }

    public void onClickPersistentDiarrhoea(View view) {
        Intent i = new Intent(this, PersistentDiarrhoea.class);
        startActivity(i);
    }

    public void onClickDysentery(View view) {
        Intent i = new Intent(this, Dysentery.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
