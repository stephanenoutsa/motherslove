...
public class SignsOfLabour extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_signs_of_labour);
        ...
        TextView signsOfLabour = (TextView) findViewById(R.id.signsOfLabour);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        signsOfLabour.setTypeface(typeface);
    }
