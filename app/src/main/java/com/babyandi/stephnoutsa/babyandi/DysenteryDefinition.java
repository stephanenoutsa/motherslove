...
public class DysenteryDefinition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dysentery_definition);
        ...
        TextView looseStoolWithBloodLabel = (TextView) findViewById(R.id.looseStoolWithBloodLabel);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        dysenteryDefinition.setTypeface(typeface);
        looseStoolWithBloodLabel.setTypeface(typeface);
    }
