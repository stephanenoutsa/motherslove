...
public class ThirdAncVisit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_third_anc_visit);
        ...
        TextView thirdAncVisitText = (TextView) findViewById(R.id.thirdAncVisitText);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        thirdAncVisitText.setTypeface(typeface);
    }
