...
public class CommonComplaintsDuringPregnancy extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_common_complaints_during_pregnancy);
        ...
        TextView commonPregnancyComplaints = (TextView) findViewById(R.id.commonPregnancyComplaints);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        commonPregnancyComplaints.setTypeface(typeface);
    }
