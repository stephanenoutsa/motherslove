...
public class PersistentDiarrhoeaTypes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_persistent_diarrhoea_types);
    ...
    public void onClickSeverePersistentDiarrhoea(View view) {
        Intent i = new Intent(this, SeverePersistentDiarrhoea.class);
        startActivity(i);
    }

    public void onClickNonSeverePersistentDiarrhoea(View view) {
        Intent i = new Intent(this, NonSeverePersistentDiarrhoea.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
