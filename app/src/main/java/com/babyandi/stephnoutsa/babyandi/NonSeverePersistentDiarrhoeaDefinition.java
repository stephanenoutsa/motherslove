...
public class NonSeverePersistentDiarrhoeaDefinition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_severe_persistent_diarrhoea_definition);
        ...
        nonSeverePersistentDiarrhoeaDefinition.setTypeface(typeface);
    }
