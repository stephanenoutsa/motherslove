...
public class SevereMalnutrition extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_severe_malnutrition);
        ...
        TextView severeMalnutrition = (TextView) findViewById(R.id.severeMalnutrition);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        severeMalnutrition.setTypeface(typeface);
    }
