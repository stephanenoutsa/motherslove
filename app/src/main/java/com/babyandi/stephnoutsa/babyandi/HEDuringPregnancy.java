...
public class HEDuringPregnancy extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_heduring_pregnancy);
        ...
        TextView hEDuringPregnancy = (TextView) findViewById(R.id.hEDuringPregnancy);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        hEDuringPregnancy.setTypeface(typeface);
    }
