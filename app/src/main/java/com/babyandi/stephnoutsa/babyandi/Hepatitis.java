...
public class Hepatitis extends AppCompatActivity {
    ...
    public void onClickHepatitisIntroduction(View view) {
        Intent i = new Intent(this, HepatitisIntroduction.class);
        startActivity(i);
    }

    public void onClickHepatitisApproach(View view) {
        Intent i = new Intent(this, HepatitisApproach.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
