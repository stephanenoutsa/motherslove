...
public class PersistentDiarrhoea extends AppCompatActivity {
    ...
    public void onClickPersistentDiarrhoeaDefinition(View view) {
        Intent i = new Intent(this, PersistentDiarrhoeaDefinition.class);
        startActivity(i);
    }

    public void onClickPersistentDiarrhoeaTypes(View view) {
        Intent i = new Intent(this, PersistentDiarrhoeaTypes.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
