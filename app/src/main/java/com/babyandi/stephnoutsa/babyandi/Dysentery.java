...
public class Dysentery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dysentery);
    ...
    public void onClickDysenteryDefinition(View view) {
        Intent i = new Intent(this, DysenteryDefinition.class);
        startActivity(i);
    }

    public void onClickDysenteryDiagnosis(View view) {
        Intent i = new Intent(this, DysenteryDiagnosis.class);
        startActivity(i);
    }

    public void onClickDysenteryTreatment(View view) {
        Intent i = new Intent(this, DysenteryTreatment.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
