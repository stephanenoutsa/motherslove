...
public class HepatitisApproach extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hepatitis_approach);
    ...
    public void onClickHepatitisStep1(View view) {
        Intent i = new Intent(this, HepatitisStep1.class);
        startActivity(i);
    }

    public void onClickHepatitisStep2(View view) {
        Intent i = new Intent(this, HepatitisStep2.class);
        startActivity(i);
    }
    public void onClickHepatitisStep3(View view) {
        Intent i = new Intent(this, HepatitisStep3.class);
        startActivity(i);
    }

    public void onClickHepatitisStep4(View view) {
        Intent i = new Intent(this, HepatitisStep4.class);
        startActivity(i);
    }
    public void onClickHepatitisStep5(View view) {
        Intent i = new Intent(this, HepatitisStep5.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
