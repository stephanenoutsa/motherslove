...
public class SpecialNeeds extends AppCompatActivity {
    ...
    public void onClickHIV(View view) {
        Intent i = new Intent(this, HIV.class);
        startActivity(i);
    }

    public void onClickHepatitis(View view) {
        Intent i = new Intent(this, Hepatitis.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
