...
public class Labour extends AppCompatActivity {
    ...
    public void onClickSignsOfLabour(View view) {
        Intent i = new Intent(this, SignsOfLabour.class);
        startActivity(i);
    }

    public void onClickPainManagement(View view) {
        Intent i = new Intent(this, PainManagement.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
