...
public class HepatitisStep2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hepatitis_step2);
        ...
        TextView hepatitisStep2 = (TextView) findViewById(R.id.hepatitisStep2);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        hepatitisStep2.setTypeface(typeface);

        Button goToStep3 = (Button) findViewById(R.id.goToStep3);
        goToStep3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), HepatitisStep3.class);
                startActivity(i);
            }
        });
    }
