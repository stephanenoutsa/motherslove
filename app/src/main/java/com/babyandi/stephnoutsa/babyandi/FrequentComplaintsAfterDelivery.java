...
public class FrequentComplaintsAfterDelivery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frequent_complaints_after_delivery);
        ...
        TextView frequentComplaints = (TextView) findViewById(R.id.frequentComplaints);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        frequentComplaints.setTypeface(typeface);
    }
