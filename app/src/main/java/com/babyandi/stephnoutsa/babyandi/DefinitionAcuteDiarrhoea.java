...
public class DefinitionAcuteDiarrhoea extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_definition_acute_diarrhoea);
        ...
        TextView normalStoolColor = (TextView) findViewById(R.id.normalStoolColor);
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/mufferaw rg.ttf");
        acuteDiarrhoeaDefinition.setTypeface(typeface);
        normalStoolColor.setTypeface(typeface);
    }
