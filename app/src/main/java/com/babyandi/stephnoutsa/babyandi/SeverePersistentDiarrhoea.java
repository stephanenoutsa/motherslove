...
public class SeverePersistentDiarrhoea extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_severe_persistent_diarrhoea);
    ...
    public void onClickSeverePersistentDiarrhoeaDefinition(View view) {
        Intent i = new Intent(this, SeverePersistentDiarrhoeaDefinition.class);
        startActivity(i);
    }

    public void onClickSeverePersistentDiarrhoeaTreatment(View view) {
        Intent i = new Intent(this, SeverePersistentDiarrhoeaTreatment.class);
        startActivity(i);
    }
    //////////End of Intents/////////////////////
