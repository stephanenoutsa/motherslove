...
public class PresentationAcuteDiarrhoea extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_presentation_acute_diarrhoea);
        ...
        acuteDiarrhoeaPresentation.setTypeface(typeface);
    }
